 ...
 */
export declare function safeDateFormat(
 ...
 */
export declare function safeDateRangeFormat(
 ...
 */
export declare function safeMultipleDatesFormat(
  dates: Date[],
  props: {
    dateFormat: string | string[];
    locale?: Locale;
 ...
 */
export declare function isDayInRange(
  day: Date,
  startDate: Date,
  endDate: Date,
): boolean;
 ...
 */
export declare function registerLocale(
  localeName: string,
 ...
 */
export declare function getLocaleObject(
  localeSpec?: Locale,
): LocaleObj | undefined;
/**
 ...
 */
export declare function getFormattedWeekdayInLocale(
  date: Date,
 ...
 */
export declare function getWeekdayMinInLocale(
  date: Date,
  locale?: Locale,
): string;
/**
 ...
 */
export declare function getWeekdayShortInLocale(
  date: Date,
  locale?: Locale,
): string;
/**
 ...
 * @returns - The month.
 */
export declare function getMonthInLocale(
  month: number,
  locale?: Locale,
): string;
/**
 ...
 */
export declare function getMonthShortInLocale(
  month: number,
  locale?: Locale,
): string;
/**
 ...
 */
export declare function getQuarterShortInLocale(
  quarter: number,
  locale?: Locale,
): string;
 ...
 */
export declare function isDayDisabled(
  day: Date,
  {
    minDate,
    maxDate,
 ...
 */
export declare function isDayExcluded(
  day: Date,
  {
    excludeDates,
    excludeDateIntervals,
...
export declare function isMonthDisabled(
  month: Date,
  {
    minDate,
    maxDate,
...
export declare function isMonthInRange(
  startDate: Date,
  endDate: Date,
  m: number,
  day: Date,
 ...
 */
export declare function isMonthYearDisabled(
  date: Date,
  {
    minDate,
    maxDate,
...
export declare function isQuarterDisabled(
  quarter: Date,
  {
    minDate,
    maxDate,
...
export declare function isYearInRange(
  year: number,
  start?: Date | null,
  end?: Date | null,
): boolean;
export declare function isYearDisabled(
  year: number,
  {
    minDate,
    maxDate,
...
export declare function isQuarterInRange(
  startDate: Date,
  endDate: Date,
  q: number,
  day: Date,
): boolean;
export declare function isOutOfBounds(
  day: Date,
...
export declare function isTimeDisabled(
  time: Date,
  {
    excludeTimes,
    includeTimes,
    filterTime,
  }?: Pick<TimeFilterOptions, "excludeTimes" | "includeTimes" | "filterTime">,
): boolean;
export declare function isTimeInDisabledRange(
  time: Date,
  { minTime, maxTime }: Pick<TimeFilterOptions, "minTime" | "maxTime">,
): boolean;
export declare function monthDisabledBefore(
  day: Date,
  {
    minDate,
    includeDates,
...
export declare function monthDisabledAfter(
  day: Date,
  {
    maxDate,
    includeDates,
...
export declare function quarterDisabledBefore(
  date: Date,
  {
    minDate,
    includeDates,
...
export declare function quarterDisabledAfter(
  date: Date,
  {
    maxDate,
    includeDates,
...
export declare function yearDisabledBefore(
  day: Date,
  {
    minDate,
    includeDates,
...
export declare function yearsDisabledBefore(
  day: Date,
  {
    minDate,
    yearItemNumber,
...
export declare function yearDisabledAfter(
  day: Date,
  {
    maxDate,
    includeDates,
...
export declare function yearsDisabledAfter(
  day: Date,
  {
    maxDate,
    yearItemNumber,
...
export declare function getEffectiveMinDate({
  minDate,
  includeDates,
}: Pick<DateFilterOptions, "minDate" | "includeDates">): Date | undefined;
export declare function getEffectiveMaxDate({
  maxDate,
  includeDates,
 ...
 */
export declare function getHighLightDaysMap(
 ...
 */
export declare function getHolidaysMap(
 ...
 */
export declare function timesToInjectAfter(
  startOfDay: Date,
  currentTime: Date,
 ...
 */
export declare function getYearsPeriod(
  date: Date,
  yearItemNumber?: number,
): {
  startPeriod: number;
 ...
 */
export declare function isSpaceKeyDown(
